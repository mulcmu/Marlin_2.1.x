...
#define CHAMBER_AUTO_FAN_SPEED 150
#define COOLER_AUTO_FAN_TEMPERATURE 18
#define COOLER_AUTO_FAN_SPEED 100
 ...
 */
//#define ADAPTIVE_STEP_SMOOTHING //Define on AMB8_Config
...
#if EITHER(IS_ULTIPANEL, EXTENSIBLE_UI, HAS_DWIN_E3V2)
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define LCD_INFO_MENU  //Define on AMB8_Config
   ...
   */
  //#define LED_CONTROL_MENU   //Define on AMB8_Config
...
// LCD Print Progress options
  ...
  #define LCD_PROGRESS_BAR                 //LCD_AMB8 LCD Show a progress bar on HD44780 LCDs for SD printing
   ...
   * point in the file.
   */
  //#define POWER_LOSS_RECOVERY  //Define on AMB8_Config
  ...
  #define SCROLL_LONG_FILENAMES //EVO3.0
   ...
   */
  //#define AUTO_REPORT_SD_STATUS //AMB8_LCD
 ...
 */
  ...
  // Western only. Not available for Cyrillic, Kana, Turkish, Greek, or Chinese.
  #define USE_SMALL_INFOFONT  //LCD_AMB8
 ...
 */
#define BABYSTEPPING  ////201907 TouchMi (permet d’ajuster en cours de print (en général lors de la première couche) la hauteur de la buse en temps réel.
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  2       //1=0.0025 4=0.01  // Babysteps are very small. Increase for faster motion.
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // TouchMi // Combine M851 Z and Babystepping
 ...
 */
//#define LIN_ADVANCE   //Define on AMB8_Config//201907 E3D
 ...
 */
//#define G29_RETRY_AND_RECOVER //20181017 à essayer
   ...
   */
  #define G29_SUCCESS_COMMANDS "M117 Succés Mesures niveaux plateau."
  #define G29_RECOVER_COMMANDS "M117 Echec Sonde Nivellement. Rewiping.\nG28\nG12 P0 S12 T0"
  #define G29_FAILURE_COMMANDS "M117 Echec Nivellement.\nG0 Z10\nM300 P25 S880\nM300 P50 S0\nM300 P25 S880\nM300 P50 S0\nM300 P25 S880\nM300 P50 S0\nG4 S1"
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                  //Define on AMB8_Config //BEAR RAMPS//EVO3.1 Disable this feature to save ~3226 bytes
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
//#define MINIMUM_STEPPER_PULSE 1 //2 //UART
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
//#define MAXIMUM_STEPPER_RATE 5000000 //TMC 250000
...
//#define ADVANCED_PAUSE_FEATURE    //Define on AMB8_Config //MODRUNOUT
  ...
  //Charger automatiquement le filament lors de la reprise.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   6  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    10  // (mm) Slow length, to allow time to insert material.
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  //15 //30  //BEAR 6  // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    80  //BEAR 80  //0  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  // For Bowden, the full length of the tube and nozzle.
                                                  // For direct drive, the full length of the nozzle.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       5   //13  // (mm) Unload initial retract length.
  #define FILAMENT_UNLOAD_PURGE_DELAY       5000  // (ms) Delay for the filament to cool after retract.
  #define FILAMENT_UNLOAD_PURGE_LENGTH         8  // (mm) An unretract is done, then this length is purged.
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      25  // (mm/s) feedrate to purge before unload

  //Temps pour éteindre la chaleur à la buse après le déclenchement de l'événement.
  #define PAUSE_PARK_NOZZLE_TIMEOUT           45  // (seconds) Time limit before the nozzle is turned off for safety.
  #define FILAMENT_CHANGE_ALERT_BEEPS         10  // Number of alert beeps to play when a response is needed.
  //Activer les steppers XYZ pour rester allumés pendant le changement de filament.
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.
  //Déplacer la tête vers une position de parc après le déclenchement de l'événement.
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change
  //Option permettant de rétablir la tête avant de passer à la position de parc après le déclenchement de l'événement.
...
// A8 Board uses Vref = 0.65V or Imax of 740mA
...
// TMC drivers use rms current not max(peak) so Irms is 740mA/1.414 = 523mA
   ...
   */
  //#define SOFTWARE_DRIVER_ENABLE  //UART (no utilisé)
   ...
   */
  #define STEALTHCHOP_XY  //UART Si on commente, on bascule en mode SpreadCycle
   ...
   */
  #define SQUARE_WAVE_STEPPING  //Stable LinearAdvance

  /**
   * Enable M122 debugging command for TMC stepper drivers.
   * M122 S0/1 will enable continuous reporting.
   */
  #define TMC_DEBUG //Activ UART
 ...
 */
#define AUTO_REPORT_TEMPERATURES	//201810 annonce la T°C Prend 290 bytes
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT  //OPT
#endif
