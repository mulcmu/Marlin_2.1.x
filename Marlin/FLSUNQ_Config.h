 ...
 * ====== Default eStep (T=397/422)/(B=417)/(n=720) ========
 * =========================================================
 */
...
#define G26_MESH_VALIDATION            // (Default) Print Mesh Validation Pattern tool(By menu).
//#define SKEW_CORRECTION              // This feature corrects for misalignment in the XYZ axes.
