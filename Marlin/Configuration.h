...
#define DELTA
  ...
  #endif
  #ifdef Q5
    #define DELTA_PRINTABLE_RADIUS  95.0  //100
...
//#define INVERT_E0_DIR true  // TITAN Extruder (Stock)
...
//#define TOUCH_SCREEN  //Disable when using LVGL
  ...
  #define TOUCH_IDLE_SLEEP 600 // (secs) Turn off the TFT backlight if set (5mn)
