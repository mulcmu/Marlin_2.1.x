...
#define TEMP_BED_RESIDENCY_TIME      2  //10 (seconds) Time to wait for bed to "settle" in M190
...
#define BANG_MAX 200     //250 Limits current to nozzle while in bang-bang mode; 255=full current
...
#define DELTA
  ...
  //#define DELTA_CALIBRATION_MENU  //Define on FLSUNQ_Config
...
#define DEFAULT_EJERK    EJERK  // May be used by Linear Advance
...
#define PREHEAT_4_FAN_SPEED   200 // Value from 0 to 255
